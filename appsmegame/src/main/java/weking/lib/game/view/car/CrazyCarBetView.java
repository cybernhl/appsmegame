...
public class CrazyCarBetView extends RelativeLayout{
    ...
    public CrazyCarBetView(Context context) {
        this(context, null);
    }

    public CrazyCarBetView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        LayoutInflater.from(context).inflate(R.layout.game_layout_cowboy_bet_view, null);
    ...
    private void setImageRes(ImageView image, int bet) {
        int betRes = GameUIUtils.getBetRes(0);
